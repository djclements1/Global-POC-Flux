function matrixOut = smooth2a(matrixIn_pre,Nr,Nc)
...
if isa(matrixIn_pre,'single')
    wasSingle = 1;
    matrixIn_pre = double(matrixIn_pre);
else
    wasSingle = 0;
end

matrixIn = [matrixIn_pre(end-Nr+1:end,:); matrixIn_pre; matrixIn_pre(1:Nr,:)];
